...
async function getGeneration(positive) {
  ...
  if (positive)
    prompt =
      "Give me a sentence that is less than 8 words to compliment someone's hardwork. Only respond with the sentence. NO other text.";
  else
    prompt =
      "Give me a sentence that is less than 8 words that push someone to work harder. Only respond with the sentence. NO other text.";
